...
titles = {'Lowess Fits: $\phi = 15^{\circ}$, Material = Steel',...
    'Lowess Fits: $\phi = 30^{\circ}$, Material = Durable Resin',...
    'Lowess Fits: $\phi = 30^{\circ}$, Material = Steel',...
    'Lowess Fits: $\phi = 45^{\circ}$, Material = Steel',...
    'Lowess Fits: $\phi = 15^{\circ}$, Material = Steel',...
    'Lowess Fits: $\phi = 30^{\circ}$, Material = Durable Resin',...
    'Lowess Fits: $\phi = 30^{\circ}$, Material = Steel',...
    'Lowess Fits: $\phi = 45^{\circ}$, Material = Steel'};

outfiles = {'Integrity_Phi15_MaterialSteel.pdf',...
    'Integrity_Phi30_MaterialDurableResin.pdf',...
    'Integrity_Phi30_MaterialSteel.pdf',...
    'Integrity_Phi45_MaterialSteel.pdf',...
    'Shellability_Phi15_MaterialSteel.pdf',...
    'Shellability_Phi30_MaterialDurableResin.pdf',...
    'Shellability_Phi30_MaterialSteel.pdf',...
    'Shellability_Phi45_MaterialSteel.pdf'};
