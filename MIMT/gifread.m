...
%
%       As of R2021a, changes to both imread and imfinfo support files will cause imfinfo to 
%       misreport frame count, file size, and the remaining color table.  Compounding the prior 
%       bug, imread will destructively alter both the image and the single remaining color table. 
%       As far as I know, there is no workaround.  As this bug appears to be quite intentional, 
%       assume that MATLAB will no longer have multiframe GIF support after R2021a.
