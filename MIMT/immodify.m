...
if ~isempty(h)
	...
	blurmodestrings = {'gaussian','glow1','glow2','disk','ring','motion','rect','3dot','4dot','bars','cross'};
...
function resetparams()
	...
	switch thistweakmode
		case {'hsl','hsv','hsi','hsy','hsyp','huslab','huslpab','husluv','huslok','huslpuv','huslpok'}
			transition(2) = 1;
		case {'lchab','lchuv','lchsr','lchok','ypbpr'}
			transition(2) = 2;
		case 'rgb'
			transition(2) = 3;
	end
